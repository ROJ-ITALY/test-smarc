...
function disk_check
{
	if [ -e /dev/disk/by-path/platform-ci_hdrc.1-usb-0:1.2:1.0-scsi-0:0:0:0 ]
	then
		echo "- USB device connected to mini pci port."
		dev="/dev/disk/by-path/platform-ci_hdrc.1-usb-0:1.2:1.0-scsi-0:0:0:0"
	else
